...
export class ConfigBuilderApiClient {
  ...
  async getClassSchema(className: string): Promise<unknown> {
  ...
  async loadConfig(payload: LoadConfigRequest): Promise<unknown> {
  ...
  async configMetadata(payload: ConfigMetadataRequest): Promise<unknown> {
